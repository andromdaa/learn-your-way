...
- 2026-04-29: Phase-1 acceptance criteria closed. `tests/integration/test_parser_openstax.py` unskipped (`@pytest.mark.skipif` on fixture absence); test ran green in 7.9 s against `tests/fixtures/openstax_chapter.pdf` (7 heuristic concepts, all span assertions passing). CLI inspection output reviewed and approved by user. Phase 2 may open.
